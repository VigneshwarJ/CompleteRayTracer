...
static MainApp* s_Instance = nullptr;
...
MainApp::MainApp(int wWidth , int wHeight ):
    window(nullptr),
    windowWidth(wWidth),
...
VkPhysicalDevice& MainApp::GetPhysicalDevice()
{
    return g_PhysicalDevice;
}

VkDevice& MainApp::GetDevice()
{
    return g_Device;
}

VkCommandBuffer& MainApp::GetCommandBuffer(bool begin)
{
    ImGui_ImplVulkanH_Window* wd = &g_MainWindowData;
...
void MainApp::FlushCommandBuffer(VkCommandBuffer commandBuffer)
{
...
void MainApp::SubmitResourceFree(std::function<void()>&& func)
{
